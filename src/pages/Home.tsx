      ...
      <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-amber-50 to-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <a href="https://apps.apple.com/app/eatme-coach/id6759190900" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 bg-black hover:bg-gray-800 text-white px-7 py-3.5 rounded-xl text-base font-medium transition-colors">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl p-8 text-white relative overflow-hidden">
              <div className="absolute top-4 right-4 bg-white/20 px-3 py-1 rounded-full text-sm">🎁 첫 달 무료</div>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-2xl">👑</span>
              ...
              <div className="mb-4">
                <div className="text-4xl font-bold">₩4,900<span className="text-lg font-normal text-amber-200">/월</span></div>
                <p className="text-amber-100 text-sm mt-1">첫 1개월 무료 체험 가능</p>
              </div>
              ...
              <div className="bg-white/20 rounded-lg p-3 mb-4">
                <p className="text-sm font-semibold mb-1">🎁 1개월 무료 체험</p>
                <p className="text-xs text-amber-50">전문가 인증 신청 후 승인되면 1개월 무료로 모든 PRO 기능을 체험할 수 있어요. 이후 월 ₩4,900으로 계속 이용 가능합니다.</p>
              </div>
              <ul className="space-y-3 mb-8">
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://apps.apple.com/app/eatme-coach/id6759190900" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 bg-white text-gray-900 px-7 py-3.5 rounded-xl text-base font-medium hover:bg-gray-100 transition-colors">
